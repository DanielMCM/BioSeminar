...
Gra_ui <- function(id) {
    ...
    list(tabItem(tabName = str_c(id, "Graph"),
        box(width = 2, style = "height:100%;",
            ...
            actionButton(ns("do"), "Generate conections", style = "margin: 2px 0; width: 100%;"),
            ...
            div(style="margin: 4px 0;", HTML("<b>INSTRUCTIONS:</b> Select a disease or code and click on 'Generate conections' to expand one level of conections from the existent nodes per click.")),
